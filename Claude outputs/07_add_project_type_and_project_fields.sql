-- =====================================================================
-- 07_add_project_type_and_project_fields.sql
--
-- Implements the "Project Type" feature:
...
--      DeliveryHeadEmployeeId, NeedsReview.
...
--      with the old placeholder codes (consult/dev/bi/support/presales/
--      train/admin), which are left exactly as they are - untouched,
--      still falling back to the flat TaskTemplates.ByCategory list.
--
...
BEGIN TRANSACTION AddProjectTypeAndProjectFields;
...
BEGIN TRY
    ...
    BEGIN
        ...
        IF @@TRANCOUNT > 0 ROLLBACK TRANSACTION AddProjectTypeAndProjectFields;
...
BEGIN TRY
    ...
    BEGIN
        ...
        BEGIN
            ALTER TABLE Carbynetech_Project ADD ProjectTech NVARCHAR(100) NULL;
        ...
        BEGIN
            ALTER TABLE Carbynetech_Project ADD CustomerPO NVARCHAR(200) NULL;
        ...
        BEGIN
            ALTER TABLE Carbynetech_Project ADD Notes NVARCHAR(1000) NULL;
...
BEGIN TRY
    ...
    BEGIN
        ...
        PRINT 'If it looks right: run  COMMIT TRANSACTION AddProjectTypeAndProjectFields;';
        PRINT 'If anything looks wrong: run  ROLLBACK TRANSACTION AddProjectTypeAndProjectFields;';
    END
END TRY
BEGIN CATCH
...
-- ---------------------------------------------------------------------
-- COMMIT TRANSACTION AddProjectTypeAndProjectFields;
-- ROLLBACK TRANSACTION AddProjectTypeAndProjectFields;
