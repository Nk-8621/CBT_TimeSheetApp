...
public interface IMasterDataRepository
{
	...
	/// <summary>Every Project Type with its full Module/Task template tree
	/// loaded - backs the admin template-management screen's "all types at
	/// once" view.</summary>
	Task<IReadOnlyList<ProjectType>> GetProjectTypesWithTemplatesAsync(CancellationToken ct = default);
